<script>
  ...
  <div class=" h-full w-full flex flex-col justify-between bg-gray-50 bg-opacity-30 p-8 rounded-xl border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
    ...
    <button class="text-blue-600 justify-center bg-blue-50 border border-blue-600 px-6 py-2 rounded-full w-full font-semibold flex items-center hover:text-blue-700 transition-colors">
      Read More
